...
<header>
    <div class="header">
        <div class="header-logo">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="40px" viewBox="0 0 493 133" enable-background="new 0 0 493 133" xml:space="preserve">
            <g id="Layer_2">
                <g>
        ...
        <div class="header-navBar">
            <ul class="header-navBarList">
                <li class="header-navBarList-item1">portal gun</li>
                <li class="header-navBarList-item2">escape game</li>
                <li class="header-navBarList-item3">inscription</li>
            </ul>
        </div>
    </div>
</header>
...
<section class="Home">
  <div class="Home-header">
    <h2 class="Home-headerText">Venez vivre l'innovation</h2>
  </div>
</section>
...
<section class="Escape-section">
  ...
  <div class="Escape-section__registration">
    ...
    <div class="Escape-section__registration__container">
      <a href="register.php" class="Escape-section__registration__container__link"><img src="images/test.svg" alt="register_icon"></a>
    </div>
  </div>
</section>
